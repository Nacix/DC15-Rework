...
SWEP.Type							= "Long-Range Heavy Blaster Rifle"
SWEP.DrawAmmo						= true
SWEP.data 							= {}
...
SWEP.CrouchRecoilMultiplier			= 0.75
...
SWEP.Scope2Pos = Vector(-2.882, -3.5, 2.945)
SWEP.Scope2Ang = Vector(0, 0, 0)

SWEP.Scope4Pos = Vector(-2.845, -3.5, 3.365) --
SWEP.Scope4Ang = Vector(0, 0, 0)

SWEP.Attachments = {
	[1] = {
		header = "Scopes",
		atts = {"scope_a280", "scope_dc15a"},
	},
	[2] = {
		header = "Muzzles",
